      ...
      <div class="content-primary" id="ProgramRuleUser">
         <ul data-role="listview" data-filter="true" id="ProgramRuleUserList" data-icon="arrow-r" data-inset="true" >
            ...
            <li data-name=<?php echo "pru".$id; ?> data-icon="gear">
               ...
               <h6>
               <label for="rulevalueselect" style="font-size:9px !important;"><?php echo $row[1]; ?></label>
               <div class="containing-element">
                  
                <?php if ( $ruletype != "gas" ) { ?>
                  <select class="rulevalueselect" name="rulevalueselect" id=<?php echo "pru".$id."_rulevalue"; ?> data-role="slider" data-mini="true">
                  <?php if ( $row[2] ==1) { ?>
                     <option value="1" selected="1">in</option>
                     <option value="0">out</option>
                  <?php } else { ?>
                     <option value="1">in</option>
                     <option value="0"  selected="0">out</option>
                  <?php } ?>
                  </select>
                <?php } ?>
               ...
               <p style="font-size:10px !important;"> 
                  ...
                  <?php if ( $userruletype == "gashigh" ) { ?>
                     <a href="#pageUpdateGAS"> Customise</a>
                  <?php } else if ( $userruletype == "gaslow" ) { ?>                   
                     <a href="#pageUpdateGAS"> Customise</a>
                  <?php } else if ( strpos($userruletype, "gas" ) !== false ) { ?>                   
                  	<a href="#pageUpdateRuleUser" data-ajax="false"> Customise</a>
                  <?php } else { ?>               	   
                  	<a href="#popupProgramRuleUser" data-rel="popup" data-position-to="window" data-transition="pop">
                     Save Changes</a>
                   <?php } ?>
            </li>
...
<div data-role="popup" id="popupProgramRuleUser" class="ui-content" style="max-width:340px;">
...
$( '#popupProgramRuleUser' ).on( 'popupbeforeposition',function(event){
