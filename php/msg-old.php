            ...
            <div class="content-primary" id="Msg">
               ...
               ?>
                  <li data-name=<?php echo "msg".$id; ?> data-inset="true" >                       
                     ...
                     <div class="ui-grid-b">     
                        <div class="ui-block-a" style="font-weight:normal; width:15%; font-size:11px !important;">                           
                           <img src="images/<?php echo $awardtype ?>.png" style="width: 20px; height: 20px;"  title="cockateil" alt="cockateil" class="ui-li-thumb">  
                        </div>
                        ...
                        <?php if ( $isread == 0 ) { ?>
                        <div class="ui-block-b" style="font-weight:bold; width:80%; font-size:13px !important;">
                           <?php echo $msgtxt; ?>
                        </div>
                        <?php } else { ?>
                  ...
                  <li data-name=<?php echo "msg".$id; ?> data-inset="true" >                       
                     ...
                     <img src="images/<?php echo $awardtype ?>.png" title="cockateil" alt="cockateil" class="ui-li-thumbsmall">  
                     </div>
                     <h4 class="ui-li-heading" style="width:80%;font-weight:normal;font-size:9px !important;"> <?php echo $msgdate." - ".$username; ?> </h4> 
                     <?php if ( $isread == 1 ) { ?>
                       <p style="width:80%;font-weight:200;font-size:11px !important;"> <?php echo $msgtxt; ?> </p>
                     <?php } else { ?> 
                       <p style="width:80%;font-weight:bold;font-size:11px !important;"> <?php echo $msgtxt; ?> </p>
                     <?php } ?>
                     </a>  
                  </li>
